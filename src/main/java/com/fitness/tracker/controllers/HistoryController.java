...
public class HistoryController {
    ...
    @GetMapping("/log-performance-page")
    public String showLogPerformancePage(HttpSession session, Model model) {
    ...
    @PostMapping("/save-performance-page")
    public String savePerformancePage(
        ...
        try {
            ...
            return "redirect:/log-performance-page";
        }
    ...
    public String history(
        ...
        model.addAttribute("user", user);
        model.addAttribute("programs", trainingProgramRepository.findAllByOrderByNameAsc());
        model.addAttribute("performances", performanceService.getUserPerformancesWithFilters(user, startDate, endDate, programId));
